...
// Runtime types generated with workerd@1.20260310.1 2026-03-05 global_fetch_strictly_public,no_handle_cross_request_promise_resolution,nodejs_compat
...
> & { readonly id: DurableObjectId; readonly name?: string };
...
type R2Range = { offset: number; length?: number } | { offset?: number; length: number } | { suffix: number };
...
type R2Objects = { objects: R2Object[]; delimitedPrefixes: string[] } & (
...
type WebSocketEventMap = { close: CloseEvent; message: MessageEvent; open: Event; error: ErrorEvent };
/**
...
type AiSearchSearchRequest = {
    messages: Array<{ role: "system" | "developer" | "user" | "assistant" | "tool"; content: string | null }>;
    ai_search_options?: {
        retrieval?: {
        ...
        query_rewrite?: { enabled?: boolean; model?: string; rewrite_prompt?: string; [key: string]: unknown };
        reranking?: {
...
type AiSearchSearchResponse = {
    ...
    chunks: Array<{
        ...
        score: number;
        text: string;
        item: { timestamp?: number; key: string; metadata?: Record<string, unknown> };
        scoring_details?: {
...
type AiImageClassificationInput = { image: number[] };
type AiImageClassificationOutput = { score?: number; label?: string }[];
...
type AiImageToTextOutput = { description: string };
...
type AiImageTextToTextOutput = { description: string };
declare abstract class BaseAiImageTextToText {
    inputs: AiImageTextToTextInput;
    postProcessedOutputs: AiImageTextToTextOutput;
}
type AiMultimodalEmbeddingsInput = { image: string; text: string[] };
type AiIMultimodalEmbeddingsOutput = { data: number[][]; shape: number[] };
declare abstract class BaseAiMultimodalEmbeddings {
    inputs: AiImageTextToTextInput;
    postProcessedOutputs: AiImageTextToTextOutput;
}
type AiObjectDetectionInput = { image: number[] };
type AiObjectDetectionOutput = { score?: number; label?: string }[];
declare abstract class BaseAiObjectDetection {
    inputs: AiObjectDetectionInput;
    postProcessedOutputs: AiObjectDetectionOutput;
}
type AiSentenceSimilarityInput = { source: string; sentences: string[] };
type AiSentenceSimilarityOutput = number[];
declare abstract class BaseAiSentenceSimilarity {
    inputs: AiSentenceSimilarityInput;
    postProcessedOutputs: AiSentenceSimilarityOutput;
}
type AiAutomaticSpeechRecognitionInput = { audio: number[] };
...
type AiSummarizationInput = { input_text: string; max_length?: number };
type AiSummarizationOutput = { summary: string };
declare abstract class BaseAiSummarization {
    inputs: AiSummarizationInput;
    postProcessedOutputs: AiSummarizationOutput;
}
type AiTextClassificationInput = { text: string };
type AiTextClassificationOutput = { score?: number; label?: string }[];
declare abstract class BaseAiTextClassification {
    inputs: AiTextClassificationInput;
    postProcessedOutputs: AiTextClassificationOutput;
}
type AiTextEmbeddingsInput = { text: string | string[] };
type AiTextEmbeddingsOutput = { shape: number[]; data: number[][] };
...
type AiTextGenerationFunctionsInput = { name: string; code: string };
type AiTextGenerationResponseFormat = { type: string; json_schema?: any };
...
type AiTextGenerationToolOutput = { id: string; type: "function"; function: { name: string; arguments: string } };
type UsageTags = { prompt_tokens: number; completion_tokens: number; total_tokens: number };
...
type AiTextToSpeechInput = { prompt: string; lang?: string };
...
type AiTranslationInput = { text: string; target_lang: string; source_lang?: string };
type AiTranslationOutput = { translated_text?: string };
...
type ResponseIncompleteDetails = { reason?: "max_output_tokens" | "content_filter" };
type ResponsePrompt = {
    id: string;
    variables?: { [key: string]: string | ResponseInputText | ResponseInputImage } | null;
    version?: string | null;
};
type Reasoning = {
...
type ResponseContentReasoningText = { text: string; type: "reasoning_text" };
type ResponseConversationParam = { id: string };
type ResponseCreatedEvent = { response: Response; sequence_number: number; type: "response.created" };
...
type ResponseFailedEvent = { response: Response; sequence_number: number; type: "response.failed" };
...
type ResponseIncompleteEvent = { response: Response; sequence_number: number; type: "response.incomplete" };
...
type ResponseInputText = { text: string; type: "input_text" };
type ResponseInputTextContent = { text: string; type: "input_text" };
type ResponseItem =
...
type ResponseOutputRefusal = { refusal: string; type: "refusal" };
type ResponseOutputText = { text: string; type: "output_text"; logprobs?: Array<Logprob> };
...
type ResponseReasoningSummaryItem = { text: string; type: "summary_text" };
type ResponseReasoningContentItem = { text: string; type: "reasoning_text" };
...
type ResponseCompletedEvent = { response: Response; sequence_number: number; type: "response.completed" };
type ResponseTextConfig = { format?: ResponseFormatTextConfig; verbosity?: "low" | "medium" | "high" | null };
...
type Logprob = { token: string; logprob: number; top_logprobs?: Array<TopLogprob> };
...
type ToolChoiceFunction = { name: string; type: "function" };
type ToolChoiceOptions = "none";
type ReasoningEffort = "minimal" | "low" | "medium" | "high" | null;
type StreamOptions = { include_obfuscation?: boolean };
    ...
    results?: {
        channels?: {
            alternatives?: {
                confidence?: number;
                transcript?: string;
                words?: { confidence?: number; end?: number; start?: number; word?: string }[];
            }[];
        }[];
...
declare abstract class Ai<AiModelList extends AiModelListType = AiModels> {
    ...
    run<Name extends keyof AiModelList, Options extends AiOptions, InputOptions extends AiModelList[Name]["inputs"]>(
        ...
        Options extends { returnRawResponse: true } | { websocket: true }
            ? Response
            : InputOptions extends { stream: true }
              ? ReadableStream
...
type AIGatewayHeaders = {
    ...
    "cf-aig-custom-cost": { per_token_in?: number; per_token_out?: number } | { total_cost?: number } | string;
...
type CompoundFilter = { type: "and" | "or"; filters: ComparisonFilter[] };
/**
 * @deprecated AutoRAG has been replaced by AI Search.
 ...
 */
type AutoRagAiSearchRequest = AutoRagSearchRequest & { stream?: boolean; system_prompt?: string };
/**
 * @deprecated AutoRAG has been replaced by AI Search.
 * Use AiSearchChatCompletionsRequest with stream: true instead.
 * @see AiSearchChatCompletionsRequest
 */
type AutoRagAiSearchRequestStreaming = Omit<AutoRagAiSearchRequest, "stream"> & { stream: true };
/**
 * @deprecated AutoRAG has been replaced by AI Search.
 ...
 */
type AutoRagAiSearchResponse = AutoRagSearchResponse & { response: string };
/**
 * @deprecated AutoRAG has been replaced by AI Search.
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
    ...
    trim?:
        ...
        | {
              ...
              width?: number;
              height?: number;
              border?: boolean | { color?: string; tolerance?: number; keep?: number };
          };
    /**
...
type ImageTransform = {
    ...
    background?: string;
    blur?: number;
    border?: { color?: string; width?: number } | { top?: number; bottom?: number; left?: number; right?: number };
    brightness?: number;
    contrast?: number;
    ...
    gravity?:
        ...
        | "auto"
        | "entropy"
        | { x?: number; y?: number; mode: "remainder" | "box-center" };
    rotate?: 0 | 90 | 180 | 270;
    saturation?: number;
    sharpen?: number;
    trim?:
...
type ImageInputOptions = { encoding?: "base64" };
...
type ImageTransformationOutputOptions = { encoding?: "base64" };
...
declare namespace Rpc {
    ...
    export type Provider<T extends object, Reserved extends string = never> = MaybeCallableProvider<T> &
        Pick<{ [K in keyof T]: MethodOrProperty<T[K]> }, Exclude<keyof T, Reserved | symbol | keyof StubBase<never>>>;
}
declare namespace Cloudflare {
    // Type of `env`.
    //
...
declare namespace CloudflareWorkersModule {
    ...
    export const RpcStub: { new <T extends Rpc.Stubable>(value: T): Rpc.Stub<T> };
    ...
    export type WorkflowStepConfig = {
        retries?: { limit: number; delay: WorkflowDelayDuration | number; backoff?: WorkflowBackoff };
        timeout?: WorkflowTimeoutDuration | number;
    };
    export type WorkflowEvent<T> = { payload: Readonly<T>; timestamp: Date; instanceId: string };
    export type WorkflowStepEvent<T> = { payload: Readonly<T>; timestamp: Date; type: string };
    export type WorkflowStepContext = { attempt: number };
...
type ImageConversionOptions = { descriptionLanguage?: "en" | "es" | "fr" | "it" | "pt" | "de" };
type EmbeddedImageConversionOptions = ImageConversionOptions & { convert?: boolean; maxConvertedImages?: number };
type ConversionOptions = {
    ...
    docx?: { images?: EmbeddedImageConversionOptions };
    image?: ImageConversionOptions;
    pdf?: { images?: EmbeddedImageConversionOptions; metadata?: boolean };
};
...
type SupportedFileFormat = { mimeType: string; extension: string };
...
type VectorizeIndexConfig =
    | { dimensions: number; metric: VectorizeDistanceMetric }
    | {
...
interface WorkflowInstanceCreateOptions<PARAMS = unknown> {
     ...
     */
    retention?: { successRetention?: WorkflowRetentionDuration; errorRetention?: WorkflowRetentionDuration };
}
type InstanceStatus = {
    status:
