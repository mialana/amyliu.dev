/* Ported from https://github.com/christian-hackyourshack/npm/tree/main/packages/remark-sectionize-headings */
...
type MdastRoot = { type: string; children?: any[] };

export function remarkSectionizeHeadings(options: Options = {}) {
    ...
    function _sectionize(node: Node, index: number, parent: Parent) {
        ...
        if (level < 7 && (!levels || levels.includes(level))) {
            const section: Parent = {
                type: "section",
                data: { hName: "section", hProperties: addClass ? { class: getClass(addClass, level) } : {} },
                children: [],
            };
