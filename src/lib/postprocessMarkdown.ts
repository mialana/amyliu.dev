...
var SVG_SELECTOR = "img[src$='svg']"; // naive search: any <img> with 'svg' in their src attribute
var SVG_CLASS_NAME = "dynamic-inline-svg";
var SVG_INNER_CLASS_NAME = "dynamic-inline-svg-inner";
var SVG_WRAPPER_CLASS_NAME = "dynamic-inline-svg-wrapper";

// var PANZOOM_PAN_CURSOR = "grabbing"
var PANZOOM_PAN_CURSOR = "url('/resources/png/drag.png'), auto";
var PANZOOM_ZOOM_IN_CURSOR = "zoom-in";
var PANZOOM_ZOOM_OUT_CURSOR = "zoom-out";
var PANZOOM_ZOOM_CURSOR = "url('/resources/png/magnifying_glass.png'), auto";

var PANZOOM_OPTIONS: Panzoom.PanzoomGlobalOptions = {
    canvas: true,
    minScale: 0.75,
    step: 0.2,
